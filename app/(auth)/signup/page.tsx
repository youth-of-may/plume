...
export default async function Page() {
  ...
  <div className={"bg-[#FBF5D1] px-20 pt-8 pb-15 border-5 border-[#E4DCAB] rounded-3xl justify-items-center translate-x-65 translate-y-15 shadow-xl/40"}>
    ...
    <div className="mt-4 gap-x-3 justify-items-center">
            ...
            <button type="button" className="font-delius rounded-md bg-white/10 px-3 py-2 text-sm font-semibold text-[#2E2805] inset-ring inset-ring-white/5 hover:bg-white/20">upload photo</button>
      </div>
